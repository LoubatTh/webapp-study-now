...
if [ -z "${string##*$liveflag*}" ] ;then
  OPTS="--api-key sk_test_51PVBspLDBaFPKLdsGGFoEZyChBZXVVRRiXMALYUYkambWs5PtI1ggasJt0qaD3Rlj3c8XZJ85DvABSOgwPrODGVG00nrVuuIfF" # This will use the content of the password store "stripe-live" which was inserted in line 8
